...
const skills = [
  ...
  //Testing
  {name: "Elixir", level: 80, category: "testing"},
  {name: "Maven", level: 80, category: "testing"},
  {name: "Spotbugs", level: 90, category: "testing"},
  {name: "Selenium IDE", level: 95, category: "testing"},
  ...
  { name: "Agile", level: 80, category: "tools"},
